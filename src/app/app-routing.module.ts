...
const routes: Routes = [
  ...
  {path: 'PerfilEditar/:nombre', component: UsuarioEditarComponent},
  {path: 'VotacionLista/:nombre', component: VotacionListaComponent},
  {path: 'VotacionReporte/:id', component: VotacionReporteComponent},
  {path: 'ValidadorPostularse/:nombre', component: ValidadorPostularseComponent},
